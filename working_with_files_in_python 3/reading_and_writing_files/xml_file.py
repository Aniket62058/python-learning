...
# parse_xml_et('./files/xml_file.xml')
# add_xml_element_et('./files/xml_file.xml','domain','name','Loneliness of life')
change_xml_element_et('./files/xml_file.xml', 'domain', 'name', 'Loneliness of life', 'Happiness of life')
